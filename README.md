...
### ▶️ [נסה את הדמו החי](https://crewcation.co.il/)
...
| בית | משחק |
|:---:|:---:|
| ![בית](docs/screenshots/01-home-gold.png) | ![משחק](docs/screenshots/04-wheel-game.png) |

> **4 פלטות צבע** בדארק מוד (זהב / ורוד / סגול / תכלת) - נבחרות בקוד. ורוד למסיבת רווקות, למשל.
